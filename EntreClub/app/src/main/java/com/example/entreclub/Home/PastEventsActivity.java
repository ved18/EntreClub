...
import com.example.entreclub.SecAdapterClass;
...
public class PastEventsActivity extends AppCompatActivity {
    private Context mContext = PastEventsActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_homepage_past);
...
//       // setupviewpager();
        ...
        li = new ArrayList<FeedSecretary>();
        recyclerView = (RecyclerView) findViewById(R.id.recyclerView);

        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        adapterClass = new SecAdapterClass(this, li);
        recyclerView.setAdapter(adapterClass);
