...
public class AdapterClassCluster extends RecyclerView.Adapter<AdapterClassCluster.EventViewHolder> {

    public final String ID="ID";
    private Context mCtx;
    private List<FeedSecretary> li;

    public AdapterClassCluster(Context mctx, List <FeedSecretary>li)
    {
        this.mCtx=mctx;
        this.li=li;
    }
    ...
    public EventViewHolder onCreateViewHolder( ViewGroup viewGroup, int i) {
        ...
        View view=inflater.inflate(R.layout.list_layout_cluster,null);
