...
public class NotifActivitySec extends AppCompatActivity {
    private static final String TAG = "searchactivity";
    private Context mContext = NotifActivitySec.this;
    private static final int ACTIVITY_NUM = 1;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_calender_sec);
       ...
       // datepicker.init(today,nextyear.getTime()).withSelectedDate(today);
        ...
        datepicker.setOnDateSelectedListener(new CalendarPickerView.OnDateSelectedListener() {
            ...
            public void onDateUnselected(Date date) {
                        ...
                        startActivity(new Intent(NotifActivitySec.this, Pop.class));
            ...
            public void onDateSelected(Date date) {
                String selectdate = DateFormat.getDateInstance(DateFormat.FULL).format(date);
                startActivity(new Intent(NotifActivitySec.this, Pop_no_event.class));
                datepicker.init(today,nextyear.getTime()).inMode(CalendarPickerView.SelectionMode.MULTIPLE).withSelectedDates(dates);
